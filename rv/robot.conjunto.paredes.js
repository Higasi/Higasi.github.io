...
function Goal(size,x,y){
 THREE.ImageUtils.crossOrigin='';
 var textura  =THREE.ImageUtils.loadTexture('http://three.js/examples/textures/minecraft/grass.png');
 THREE.Mesh.call(this,new THREE.BoxGeometry(size,size,size),new THREE.MeshBasicMaterial({map:textura}));
 this.size=size;
 this.position.x=x;
 this.position.y=y;
...
function setup(){
 ...
 mapa[2] ="x                      x";
 mapa[3] ="x             r        x"; 
 mapa[4] ="xxxxxxxxxx  xxxxxxxxxxxx";
 mapa[5] ="x                      x";
 mapa[6] ="x                      x"; 
 mapa[7] ="x                      x";
 ...
 mapa[14]="x                      x";
 mapa[15]="x                      x";
 mapa[16]="xxxxxx   xxxxxxxxxxxxxxx";
 mapa[17]="x                      x";
 mapa[18]="x                      x";
